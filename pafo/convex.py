...
def format_eqs(lefts: List[List[float]], right: List[float]) -> Tuple[matrix, matrix]:
    ...
    Returns:
        Tuple[matrix, matrix]: Tuple of matrices of the form (variable coefficients, constants)
    """
